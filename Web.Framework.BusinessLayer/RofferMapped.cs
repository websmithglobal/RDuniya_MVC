...
{
    public class RofferMapped : COM.DALInterface, IDisposable
    {
        DAL.CRUDOperation objDAL = new DAL.CRUDOperation();
        DAL.RofferMapped clsDAL = new DAL.RofferMapped();
        public ENT.RofferMapped Entity = new ENT.RofferMapped();
        List<ENT.RofferMapped> lstEntity;
        List<string> strvalidationResult = new List<string>();

        private List<string> ValidationEntry(object obj)
        {
            strvalidationResult.Clear();
            Entity = (ENT.RofferMapped)obj;
        ...
        public bool Insert(object obj)
        {
            ...
            try
            {
                ...
                {
                    COM.HelperMethod.SetValueInObject(obj, Guid.NewGuid(), "roffermapid");
        ...
        public object GetByPrimaryKey(ENT.RofferMapped Entity)
        {
        ...
        public List<ENT.RofferMapped> GetAll(string search)
        {
            lstEntity = new List<ENT.RofferMapped>();
        ...
        public bool UpdateStatus(Guid PrimarKey, COM.MyEnumration.MyStatus Status)
        {
            ...
            try
            {
                ...
                Dictionary<string, bool> dctFields = new Dictionary<string, bool>();
                dctFields.Add(COM.HelperMethod.PropertyName<ENT.RofferMapped>(x => x.roffermapid), true);
                dctFields.Add(COM.HelperMethod.PropertyName<ENT.RofferMapped>(x => x.Status), false);
                Entity.roffermapid = PrimarKey;
