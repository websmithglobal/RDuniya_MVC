...
{
    public class ErrorLog : COM.DALInterface , IDisposable
    {
        DAL.CRUDOperation objDAL = new DAL.CRUDOperation();
        DAL.ErrorLog clsDAL = new DAL.ErrorLog();
        public ENT.ErrorLog Entity = new ENT.ErrorLog();
        List<ENT.ErrorLog> lstEntity;
        ...
        public bool Insert(object obj)
        {
            ...
            try
            {
                COM.HelperMethod.SetValueInObject(obj, Guid.NewGuid(), "errorid");
        ...
        public object GetByPrimaryKey(ENT.ErrorLog Entity)
        {
        ...
        public List<ENT.ErrorLog> GetAll()
        {
            lstEntity = new List<ENT.ErrorLog>();
