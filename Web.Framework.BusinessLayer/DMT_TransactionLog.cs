...
{
    public class DMT_TransactionLog : COM.DALInterface, IDisposable
    {
        DAL.CRUDOperation objDAL = new DAL.CRUDOperation();
        DAL.DMT_TransactionLog clsDAL = new DAL.DMT_TransactionLog();
        public ENT.DMT_TransactionLog Entity = new ENT.DMT_TransactionLog();
        List<ENT.DMT_TransactionLog> lstEntity;
        ...
        public bool Insert(object obj)
        {
            ...
            try
            {
                COM.HelperMethod.SetValueInObject(obj, Guid.NewGuid(), "dmt_transactionid");
        ...
        public object GetByPrimaryKey(ENT.DMT_TransactionLog Entity)
        {
