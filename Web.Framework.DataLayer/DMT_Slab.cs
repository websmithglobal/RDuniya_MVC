...
{
    public class DMT_Slab
    {
        #region Declare Common Object
        List<ENT.DMT_Slab> lstEntity = new List<ENT.DMT_Slab>();
        ENT.DMT_Slab objEntity = new ENT.DMT_Slab();
        ...
        public List<ENT.DMT_Slab> GetList()
        {
            try
            {
                parFields.Clear();
                ...
                {
                    lstEntity = COM.DBHelper.CopyDataReaderToEntity<ENT.DMT_Slab>(dr);
