...
{
    [Authorize]
    public class OperatorSetupController : BaseController
    {
        List<ENT.OperatorSetup> lstEntity = new List<ENT.OperatorSetup>();
        BAL.OperatorSetup objBAL = new BAL.OperatorSetup();
        ENT.OperatorSetup Model;
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.ServiceMaster = new BAL.ServiceMaster().GetAll(string.Empty);
