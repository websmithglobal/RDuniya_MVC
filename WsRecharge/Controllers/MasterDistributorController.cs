...
{
    [Authorize]
    public class MasterDistributorController : BaseController
    {
        ...
        {
            ViewBag.PageHeader = "Master Distributor";
        ...
        public JsonResult GetAll()
        {
            ...
            lstEntity = objBAL.GetAll(search.ToString().Replace("\0", string.Empty), COM.MyEnumration.Userlevel.MD);
