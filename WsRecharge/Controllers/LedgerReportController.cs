...
namespace WsRecharge.Controllers
{
    ...
    public class LedgerReportController : BaseController
    {
        ...
        [HttpPost]
        public JsonResult GetAll(int ddrange, string fromdate, string todate, int ddData, string search)
        {
            ...
            lstEntity = new BAL.LedgerReport().GetAllSearch(ddrange, fromdate.GetDate(), todate.GetDate(), ddData, search,User.GetUserlevel(), Guid.Parse(User.Identity.GetUserId()));
