...
namespace WsRecharge.Controllers
{
    ...
    public class DistributorController : BaseController
    {
        ...
        {
            ViewBag.PageHeader = "Distributor";
            return View();
        }
        ...
        public JsonResult GetAll()
        {
            ...
            lstEntity = objBAL.GetAllUnderUserList(search.ToString().Replace("\0", string.Empty), Guid.Parse(User.Identity.GetUserId()), COM.MyEnumration.Userlevel.MD);
